 ...
 */
final class Version20260210184902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_ad (user_id INT NOT NULL, ad_id INT NOT NULL, INDEX IDX_6FB7599DA76ED395 (user_id), INDEX IDX_6FB7599D4F34D596 (ad_id), PRIMARY KEY (user_id, ad_id)) DEFAULT CHARACTER SET utf8mb4');
